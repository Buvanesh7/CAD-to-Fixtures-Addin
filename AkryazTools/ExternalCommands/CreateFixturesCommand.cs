...
namespace Akryaz.ExternalCommands
{
	...
	public class CreateFixturesCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            {			
				...
				var transaction = new Transaction(document, "Create Smoke Detectors");
				transaction.Start();
				...
				var view3Dtype = collector.OfClass(typeof(View3D)).Where(x => x.GetTypeId().IntegerValue != -1).First();
